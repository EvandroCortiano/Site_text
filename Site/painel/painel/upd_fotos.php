...
<body>
	...
	<div id="cont">
		<div id="cad_agenda">
			...
			<?php 
				$query = mysql_query("SELECT * FROM fotos WHERE id_foto = $fotoid");
				
				while ($result = mysql_fetch_array($query)){
			?>			
			<!-- Formulario de cadastro -->
			<form action="update/atualizarfotos.php?id_foto=<?php echo $result['id_foto']; ?>" id="form" name="form" method="post">
				<label>Foto postada (link da foto):</label>
				<div class="ftupd"><?php echo utf8_encode($result['link_foto']); ?></div>
				<br/>
				<label for="legfoto"> Legenda da foto: </label>
				<input type="text" id="legfoto" name="legfoto" value="<?php echo utf8_encode($result['legfoto']); ?>" required />
				<br/>
				<br/><br/>
